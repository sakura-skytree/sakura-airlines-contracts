...
type UpdatePassengerRequest struct {
	...
	DocumentExpiresAt *timestamppb.Timestamp `protobuf:"bytes,9,opt,name=document_expires_at,json=documentExpiresAt,proto3,oneof" json:"document_expires_at,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
const file_passenger_v1_passenger_proto_rawDesc = "" +
	...
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\"\x8a\x04\n" +
	"\x16UpdatePassengerRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\x12\"\n" +
	"\n" +
	"first_name\x18\x03 \x01(\tH\x00R\tfirstName\x88\x01\x01\x12 \n" +
	"\tlast_name\x18\x04 \x01(\tH\x01R\blastName\x88\x01\x01\x12C\n" +
	"\rdate_of_birth\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampH\x02R\vdateOfBirth\x88\x01\x01\x12\x1b\n" +
	"\x06gender\x18\x06 \x01(\tH\x03R\x06gender\x88\x01\x01\x12(\n" +
	"\rdocument_type\x18\a \x01(\tH\x04R\fdocumentType\x88\x01\x01\x12,\n" +
	"\x0fdocument_number\x18\b \x01(\tH\x05R\x0edocumentNumber\x88\x01\x01\x12O\n" +
	"\x13document_expires_at\x18\t \x01(\v2\x1a.google.protobuf.TimestampH\x06R\x11documentExpiresAt\x88\x01\x01B\r\n" +
	"\v_first_nameB\f\n" +
	"\n" +
	"_last_nameB\x10\n" +
	"\x0e_date_of_birthB\t\n" +
