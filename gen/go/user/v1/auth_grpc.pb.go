...
func (c *authServiceClient) GetUser(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetUserResponse, error) {
...
func (UnimplementedAuthServiceServer) GetUser(context.Context, *emptypb.Empty) (*GetUserResponse, error) {
